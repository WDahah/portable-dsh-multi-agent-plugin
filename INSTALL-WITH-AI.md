...
- Verify the entry actually loads and the expected eleven orchestrator tools are visible. A file on disk, candidate YAML patch or successful doctor result is not runtime proof.
