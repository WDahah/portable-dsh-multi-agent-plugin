...
test('portable factory injects native definition adapter, mounts thirteen tools, and defaults disabled',async()=>{
  ...
  const h=context();plugin.apply(h.ctx,{stateRoot:fresh()});assert.equal(h.tools.size,13);
